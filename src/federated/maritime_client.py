...
if __name__ == "__main__":
    logger.info("🚢 启动海事GAT-PPO联邦学习客户端...")
    ...
    try:
        ...
        # 获取客户端rank (从环境变量)
        client_rank = os.environ.get('FEDML_CLIENT_RANK', '1')
        
        # 设置sys.argv以包含配置文件路径
        import sys
        if len(sys.argv) == 1:
            sys.argv.extend(["--cf", config_path, "--rank", client_rank, "--role", "client"])
